...
void printHelp() {
    ...
    std::cout << "FILE TEST MODE:\n"
              ...
              << "\t[option]\t Optional parameter: drunkenness level for Drunk Insertion Sort (0 - 100), gaps for Shell Sort (0 - 10), pivot type for Quick Sort (0 - left, 1 - right, 2 - middle, 3 - random).\n"
